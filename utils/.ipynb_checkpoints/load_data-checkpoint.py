...
def load_data(data_name=None, gcn=False, split_data=0.2, batch_size=16):
    ...
    if data_name == 'dtd':
        ...
        val_loader = torch.utils.data.DataLoader(training_data, batch_size=batch_size, shuffle=True)
        num_classes = 47
        ...
        kth_train_dataset = datasets.ImageFolder(root='./data/kth/train',
                                                 transform=transform_train)

        kth_test_dataset = datasets.ImageFolder(root='./data/kth/test',
        ...
        train_set = datasets.ImageFolder(
            root="./data/KTH-TIPS2-b", transform=transform_train)
        val_set = datasets.ImageFolder(
            root="./data/KTH-TIPS2-b", transform=transform_test)
        num_classes = 11
        split_data=0.25
